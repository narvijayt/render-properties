...
<div class="col-md-6 realtor-register_form_outer">
         @if ($errors->has('error'))
...
<div class="form-group{{ $errors->has('state') ? ' has-error' : '' }}">
	<select id="state" class="form-control" name="state" required>re
...
<div class="form-group justify-content-center">
	<button type="submit" class="btn btn-warning btn-yellow m-0" id='reg-btn'>
