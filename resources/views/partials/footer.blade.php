            ...
            <div class=" col-md-8 col-sm-9 col-xs-12 footer-flex">
                ...
                <div class="collapse navbar-collapse" id="realbroker-navbar-collapse">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li><a href="javascript:void(0)" style="display: block;" data-toggle="modal"
                                data-target="#myModal1" class="">Search Profiles</a></li>
                        ...
                        {{--<li><a href="{{ route('register') }}" class="navbar__button
                        navbar__button--register">Register</a></li>--}}
                        <li class="dropdown dropdown-top-01">
                            <a href="#" class="dropdown-toggle navbar__button navbar__button--register"
                                data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Register
                                <span class="caret"></span></a>
                            <ul class="dropdown-menu">
                                <li><a href="{{ route('realtor-register') }}"
                    ...
                    @auth
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle navbar__profile-dropdown" data-toggle="dropdown"
                            role="button" aria-haspopup="true" aria-expanded="false">
                            <img src="{{ auth()->user()->avatarUrl(\App\Enums\AvatarSizeEnum::SMALL) }}"
                                class="navbar__avatar" />
                            {{ auth()->user()->full_name() }} <span class="badge badge-brand"
                                style="background-color:red;">@if(auth()->user()->notificationCount() > 0 )
                                {{ auth()->user()->notificationCount() }} @endif</span>
                        ...
                        <ul class="dropdown-menu">
                            ...
                            {{--@endif--}}
                            <li><a href="{{ route('pub.message-center.index') }}">Message Center <span
                                        class="badge badge-brand"
                                        style="background-color:red;">@if(auth()->user()->unread_message_count() > 0
                                        ){{ auth()->user()->unread_message_count() }} @endif</span></a></li>
