                            ...
                            <div class="box-body">
                                <div class="form-group d-block w-100 mb-1">
                                    ...
                                    <div class="form-input col-md-9">
                                        <input type="text" class="form-control" name="title" id="title" value="{{ old('title') ? old('title') : $pricing->title }}" />
                                        @if ($errors->has('title'))
                                ...
                                <div class="form-group d-block w-100 mb-1">
                                    ...
                                    <div class="form-input col-md-9">
                                        <input type="text" class="form-control" name="basePrice" id="basePrice" placeholder="99.00" value="{{ old('basePrice') ? old('basePrice') : $pricing->basePrice }}" />
                                ...
                                <div class="form-group d-block w-100 mb-1">
                                    ...
                                    <div class="form-input col-md-9">
                                        <input type="text" class="form-control" name="addOnPrice" id="addOnPrice" placeholder="79.00" value="{{ old('addOnPrice') ? old('addOnPrice') : $pricing->addOnPrice }}" />
                                    ...
                                    <div class="form-input col-md-9">
                                        <select class="form-control" name="status" id="status">
                                            ...
                                            @foreach(['0' => 'inactive', '1' => 'active'] as $index=>$value)
                                                <option value="{{ $index }}"> {{ ucfirst($value) }} </option>
                                            @endforeach
                                        </select>
