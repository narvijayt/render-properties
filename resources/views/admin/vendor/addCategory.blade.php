             ...
             @if(session('error'))
                    ...
                    <div class="box box-primary">
                        ...
                        <form id="registerVendor" method="post" enctype="multipart/form-data">
                    		...
                    		<input id="industryname" type="text" class="form-control" name="industry_name"  value="{{ old('industry_name') }}" required>
                        ...
                        <div class="box-footer">
                                <button type="submit" class="btn btn-primary btn-block" id="regVend">Create Industry</button>
                            </div>
                        </form>
                    </div>
                </div>
