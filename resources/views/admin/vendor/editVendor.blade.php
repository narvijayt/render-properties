             ...
             @if(session('error'))
                    ...
                    <div class="box box-primary">
                        ...
                        <form id="registerVendor" method="post" enctype="multipart/form-data">
                    		...
                    		<input id="fname" type="text" class="form-control" name="first_name"  value="{{$users->first_name}}" required>
                    		...
                    		<input id="lname" type="text" class="form-control" name="last_name"  value="{{$users->last_name}}" required>
                    			<span class="help-block">
                            ...
                            <div class="col-md-6 {{ $errors->has('company_name') ? ' has-error' : '' }}">
                            	...
                            	<input id="cname" type="text" class="form-control" name="company_name"  value="{{$users->firm_name}}" required>
                            ...
                            <div class="col-md-6 {{ $errors->has('website') ? ' has-error' : '' }}">
                            	...
                            	<input id="website" type="text" class="form-control" name="website"  value="{{$users->website}}">
                            ...
                            <div class="box-body">
                             <div class="col-md-6 {{ $errors->has('email') ? ' has-error' : '' }}">
                            	...
                            	<input id="emailaddvend" type="text" class="form-control" name="email"  value="{{$users->email}}" required>
                        	...
                        	<input id="phone_vendor_no_vendor" type="phone_no" class="form-control" name="phone_no"  value="{{$users->phone_number}}" required>
                           ...
                           <div class="box-body">
                               <div class="col-md-12 {{ $errors->has('vendor_coverage_units') ? ' has-error' : '' }}">
                            	...
                            	<textarea rows="2" cols="20"class="form-control"  name="vendor_coverage_units" required>@if(count($vendorDet) > 0 ){{$vendorDet[0]->vendor_coverage_area}}@endif</textarea>
                          ...
                          ?>
                           <div class="box-body">
                            ...
                            <select name="select_category[]" class="form-control {{ $errors->has('select_category[]') ? ' has-error' : '' }}" id="multSelCat" multiple required>
                                    @foreach($allcat as $categoryVendor)
                                 <option value="{{$categoryVendor->id}}" @if(in_array($categoryVendor->id, $allcategory))selected @endif>{{$categoryVendor->name}}</option>
                                @endforeach
                            </select>
                          ...
                          <div class="box-body">
                          <div class="col-md-12 form-group {{ $errors->has('other_description') ? 'has-error' : '' }}" id="otherDesc">
                            ...
                            <input type="text" class="form-control" name="other_description" value="{{$allCat['description']}}" id="deafult_desc" required>
                        ...
                        @endif
                        <div class="box-body">
                         <div class="col-md-12 form-group {{ $errors->has('other_description') ? 'has-error' : '' }}" id="AdditionalDesc" style="display:none">
                            <label class="control-label" for="bio">
                                @if($errors->has('other_description'))<i class="fa fa-times-circle-o"></i>@endif Other Industry Description
                            </label>
                            <input type="text" class="form-control" name="other_description_optional" Placeholder="Other Industry Description" id="inputAdditional">
                            @if($errors->has('other_description'))
                                <span class="help-block">{{ $errors->first('other_description') }}</span>
                            @endif
                        </div>
                        ...
                        @endif
                          <div class="box-body">
                               <div class="col-md-12 form-group {{ $errors->has('services') ? ' has-error' : '' }}" >
                                   <label for="services">What services do you offer?</label>  
                                	<textarea rows="2" cols="3"class="form-control"  id="services" name="services"  required>@if(count($vendorDet) > 0 ){{$vendorDet[0]->vendor_service}}@endif</textarea>
                                ...
                                <div class="col-md-12 form-group {{ $errors->has('short_description') ? ' has-error' : '' }}">
                                    <label for="shotDesc">Short Description</label>  
                                	<textarea rows="2" cols="3"class="form-control"  id="shotDesc" name="short_description"  placeholder="Enter Short Description" required>@if($users->bio !="" && $users->bio !='null'){{$users->bio}}@endif</textarea>
                                    ...
                                    <select id="editProfileState" class="form-control" name="state" required>
                                        <option value="">Choose a state</option>
                                          @foreach($states::all() as $abbr => $stateName)
                                            <option value="{{ $abbr }}" @if ($abbr == $users->state) selected @endif>{{ $stateName }}</option>
                                        @endforeach
                                    </select>
                                    @if ($errors->has('state'))
                                        <span class="help-block">
                             ...
                             <div class="col-md-7">
                                <div class="form-group{{ $errors->has('city') ? ' has-error' : '' }}">
                                 ...
                                 <input type="text" name="city" class="form-control" id="newProfileCity" value="{{$users->city}}" placeholder="Enter City" required>
                            	@if ($errors->has('city'))
                            		<span class="help-block">
                            ...
                            <div class="col-md-5">
                                    <div class="form-group {{ $errors->has('zip') ? 'has-error' : '' }}">
                                        ...
                                        <input type="text" class="form-control" placeholder="Enter Zip Code" name="zip" value="{{$users->zip}}" />         
                                        @if($errors->has('zip'))
                        			...
                        			<div class="full editp">
                        				<div class="form-group">
                        					...
                        					<div id="image">
                        					    ...
                        					    if($ext == 'pdf'){ ?>
                        					    <img width="20%" height="20%" id="uploaded_preview_image" src="{{URL::to('/banner/')}}/preview_{{$ext}}.png"/>
                        					    <?php }else{ ?>
                        					    	<img width="20%" height="20%" id="uploaded_preview_image" src="{{URL::to('/banner/')}}/{{$findBanner[0]->banner_image}}"/>
                        					    	<?php } ?>
                        					   @endif
              ...
              success: function(data) {
                  if (data.fail) {
                     ...
                     if(ext == 'pdf'){
                          ...
                          j('#uploaded_preview_image').attr('src', '{{URL::to('/banner/')}}/' + 'preview_pdf.png');
                     }else{
                      j('#file_name_uploaded').val(data);
                      j('#uploaded_preview_image').css('display', 'block');
