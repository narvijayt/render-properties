            ...
            <div class="col-md-10">
                ...
                <div class="box box-primary">
                    ...
                    <form id="registerVendor" method="post" enctype="multipart/form-data">
                        ...
                        {{csrf_field()}}
                        <div class="box-body">
                            <div class="col-md-6 mb-1 {{ $errors->has('first_name') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6 mb-1 {{ $errors->has('last_name') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6 mb-1 {{ $errors->has('company_name') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6 mb-1 {{ $errors->has('website') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6 mb-1 {{ $errors->has('email') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6 mb-1 {{ $errors->has('phone_no') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-12 mb-1 {{ $errors->has('vendor_coverage_units') ? ' has-error' : '' }}">
                        ...
                        @if(count($allCat)>0)
                            @if(in_array('19', $allcategory))
                                ...
                                <div class="col-md-12 mb-1 form-group {{ $errors->has('other_description') ? 'has-error' : '' }}"
                                    id="otherDesc">
                        ...
                        @endif
                            ...
                            <div class="col-md-12 mb-1 form-group {{ $errors->has('services') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-12 mb-1 form-group {{ $errors->has('short_description') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-12 mb-1 form-group{{ $errors->has('state') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6 mb-1">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="payment_status" name="payment_status">
                                        <option value="1" @if($users->payment_status == 1) selected @endif>Paid
                                        </option>
                                        <option value="0" @if($users->payment_status == 0) selected
                                            @endif>Unpaid</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 mb-1">
                                ...
                                <div class="full editp">
                                    <div class="form-group">
                                        <div class="checkbox">
                                            <a href="javascript:uploadBannerImage()" style="text-decoration: none;" class="btn btn-warning"><i class="fa fa-edit"></i> Browse File </a>&nbsp;&nbsp;
                                        </div>
                                    </div>
                                    <div id="image">
