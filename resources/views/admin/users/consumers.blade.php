            ...
            <div class="col-md-12">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">Consumers</h3>
                    </div>
                    <div class="box-body">
								...
								@if(isset($users) && !empty($users))
									...
									@foreach($users as $user)
										<tr class="row_<?= $user['user_id']; ?>">
											...
											<td>
												<a href="{{url('admin/consumers/'.$user["user_id"])}}" class="edit-icon" data-toggle="tooltip" data-placement="top" title="Edit">
												...
												<a href="#" data-toggle="tooltip" data-placement="top" title="View Profile">
													<i class="fa fa-eye"></i>
												</a>
											</td>
										</tr>
