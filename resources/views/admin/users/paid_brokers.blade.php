...
@section('content')
    <section class="content-header">
        <h1>Paid Brokers List</h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Dashboard</a></li>
            <li><a href="#">Users</a></li>
            <li class="active">Paid Lenders</li>
        </ol>
    </section>
            ...
            <div class="col-md-12">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">Paid Brokers</h3>
                    </div>
                    <div class="box-body">
								...
								@if(isset($users) && !empty($users))
									...
									@foreach($users as $user)
										<tr class="row_<?= $user['user_id']; ?>">
											...
											<td>
												<!---<a href="{{url('cpldashrbcs/paid-brokers/'.$user["user_id"])}}" class="edit-icon" data-toggle="tooltip" data-placement="top" title="Edit">
