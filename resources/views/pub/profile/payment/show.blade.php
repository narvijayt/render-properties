...
@section('title') Enter Billing Information @endsection
...
@section('page_content')
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <form method="POST" action="{{ route('pub.profile.payment.subscribe') }}" id="subscription-form">
                ...
                <div class="form-group">
                    <label>Price</label>
                    <input type="text" class="form-control" value="${{ $plan->cost}}" />
                </div>

                <div id="dropin-container"></div>
                <hr>
                <input type="hidden" name="plan" value="{{ $plan->braintree_plan_id }}">
                <input type="hidden" id="nonce" name="nonce" value="">
                {{ csrf_field() }}
                <button id="payment-button" class="btn btn-warning btn-flat hidden" type="submit">Pay Now</button>
            </form>
