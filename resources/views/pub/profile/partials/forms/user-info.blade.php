...
<div class="row">
    <div class="col-xs-12">
        <div class="form-group {{ $errors->has('phone_number') ? 'has-error' : '' }}">
            ...
            <input
                    ...
                    data-politespace-strip="[^\d]*"
                    data-politespace-grouplength="3,3,4"
    ...
    @if(auth()->user()->user_type != 'vendor' && auth()->user()->user_type !='realtor' && auth()->user()->user_type != 'broker')
    <div class="col-xs-4">
...
<div class="form-group {{ $errors->has('license') ? 'has-error' : '' }}">
    ...
    <input type="text" class="form-control"  placeholder="Enter license" name="license" value="{{ old('firm_name', (isset($user->license) ? $user->license : '')) }}">
