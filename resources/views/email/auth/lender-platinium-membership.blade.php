								...
								<table cellpadding="0" cellspacing="0" border="0" align="center" width="750" class="bgContent">
									...
									<tr>
										...
										<td width="550" align="left" style="padding-bottom:20px; padding-top:5px;">
											<div class="contentEditableContainer contentTextEditable">
												<div class="contentEditable" >
													<p >{!! get_application_name() !!} will be introducing the new Platinum Membership to the public. Before that happens, existing members get the first shot to upgrade and <a target="_blank" style="font-weight:bold;" href="{{url('/platinum-membership-upgrade',[$user->user_id])}}">claim their Zip Code</a>.</p>
												</div>
											</div>
										</td>
										<td width="100">&nbsp;</td>
