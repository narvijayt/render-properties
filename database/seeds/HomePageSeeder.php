...
class HomePageSeeder extends Seeder
{
    ...
    public function run()
    {
        $banner = '<h1 class="m-0">Welcome to Render The Reals Estate Connection</h1>
        ...
        $section1 = '<h2 class="text-center h1  mb-1 mt-0">Join Render Today!</h2>
        ...
        $section5 = '<h2 class="text-left h1  mb-1 mt-0">Get Instant Access To <br />1,000s Of Real Estate Pros, <br />Nationwide!</h2>
